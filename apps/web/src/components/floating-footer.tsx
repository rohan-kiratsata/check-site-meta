  ...
  return (
    <div className="fixed bottom-4 left-1/2 flex -translate-x-1/2 items-center space-x-2 rounded-lg bg-white/60 p-2 px-3 text-sm text-gray-500 backdrop-blur-sm dark:bg-neutral-800/60 dark:text-gray-300">
      <a
        ...
        className="flex items-center space-x-1 transition-colors hover:text-gray-800 dark:hover:text-white"
      ...
      <span>
        Built by{" "}
        <Link href="https://x.com/sudorohan" className="hover:underline">
          Rohan
        </Link>
      </span>
      <span>•</span>
